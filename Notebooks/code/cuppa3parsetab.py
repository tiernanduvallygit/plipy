...
_lr_productions = [
  ...
  ('stmt -> ID = exp opt_semi','stmt',4,'p_stmt','cuppa3_frontend.py',43),
  ('stmt -> GET ID opt_semi','stmt',3,'p_stmt','cuppa3_frontend.py',44),
  ('stmt -> PUT exp opt_semi','stmt',3,'p_stmt','cuppa3_frontend.py',45),
  ('stmt -> ID ( opt_actual_args ) opt_semi','stmt',5,'p_stmt','cuppa3_frontend.py',46),
  ('stmt -> RETURN opt_exp opt_semi','stmt',3,'p_stmt','cuppa3_frontend.py',47),
  ('stmt -> WHILE ( exp ) stmt','stmt',5,'p_stmt','cuppa3_frontend.py',48),
  ('stmt -> IF ( exp ) stmt opt_else','stmt',6,'p_stmt','cuppa3_frontend.py',49),
  ('stmt -> { stmt_list }','stmt',3,'p_stmt','cuppa3_frontend.py',50),
  ('opt_formal_args -> formal_args','opt_formal_args',1,'p_opt_formal_args','cuppa3_frontend.py',78),
  ('opt_formal_args -> empty','opt_formal_args',1,'p_opt_formal_args','cuppa3_frontend.py',79),
  ('formal_args -> ID , formal_args','formal_args',3,'p_formal_args','cuppa3_frontend.py',86),
  ('formal_args -> ID','formal_args',1,'p_formal_args','cuppa3_frontend.py',87),
  ('opt_init -> = exp','opt_init',2,'p_opt_init','cuppa3_frontend.py',97),
  ('opt_init -> empty','opt_init',1,'p_opt_init','cuppa3_frontend.py',98),
  ('opt_actual_args -> actual_args','opt_actual_args',1,'p_opt_actual_args','cuppa3_frontend.py',108),
  ('opt_actual_args -> empty','opt_actual_args',1,'p_opt_actual_args','cuppa3_frontend.py',109),
  ('actual_args -> exp , actual_args','actual_args',3,'p_actual_args','cuppa3_frontend.py',116),
  ('actual_args -> exp','actual_args',1,'p_actual_args','cuppa3_frontend.py',117),
  ('opt_exp -> exp','opt_exp',1,'p_opt_exp','cuppa3_frontend.py',127),
  ('opt_exp -> empty','opt_exp',1,'p_opt_exp','cuppa3_frontend.py',128),
  ('opt_else -> ELSE stmt','opt_else',2,'p_opt_else','cuppa3_frontend.py',135),
  ('opt_else -> empty','opt_else',1,'p_opt_else','cuppa3_frontend.py',136),
  ('exp -> exp PLUS exp','exp',3,'p_binop_exp','cuppa3_frontend.py',146),
  ('exp -> exp MINUS exp','exp',3,'p_binop_exp','cuppa3_frontend.py',147),
  ('exp -> exp TIMES exp','exp',3,'p_binop_exp','cuppa3_frontend.py',148),
  ('exp -> exp DIVIDE exp','exp',3,'p_binop_exp','cuppa3_frontend.py',149),
  ('exp -> exp EQ exp','exp',3,'p_binop_exp','cuppa3_frontend.py',150),
  ('exp -> exp LE exp','exp',3,'p_binop_exp','cuppa3_frontend.py',151),
  ('exp -> INTEGER','exp',1,'p_integer_exp','cuppa3_frontend.py',158),
  ('exp -> ID','exp',1,'p_id_exp','cuppa3_frontend.py',165),
  ('exp -> ID ( opt_actual_args )','exp',4,'p_call_exp','cuppa3_frontend.py',172),
  ('exp -> ( exp )','exp',3,'p_paren_exp','cuppa3_frontend.py',179),
  ('exp -> MINUS exp','exp',2,'p_uminus_exp','cuppa3_frontend.py',186),
  ('exp -> NOT exp','exp',2,'p_not_exp','cuppa3_frontend.py',193),
  ('opt_semi -> ;','opt_semi',1,'p_opt_semi','cuppa3_frontend.py',200),
  ('opt_semi -> empty','opt_semi',1,'p_opt_semi','cuppa3_frontend.py',201),
  ('empty -> <empty>','empty',0,'p_empty','cuppa3_frontend.py',208),
]
